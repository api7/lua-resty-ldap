...
--- config
    location /t {
        content_by_lua_block {
            ...
            -- multi-value order is wire order, not sorted
            assert(#r.attributes.objectClass == 4, "objectClass count " .. #r.attributes.objectClass)
            assert(r.attributes.objectClass[1] == "top", "objectClass[1]")
            assert(r.attributes.objectClass[2] == "person", "objectClass[2]")
            assert(r.attributes.objectClass[3] == "organizationalPerson", "objectClass[3]")
